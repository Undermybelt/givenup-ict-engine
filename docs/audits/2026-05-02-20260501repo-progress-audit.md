...
| Land decisions as versioned repo artifacts | Commits `acce819`, `2bb1c8e`, `bb57d73`, `2253bfe`, `05caf1d`, `45fc44c`, `05d4ca7`, `d9631fc`, `400b00c`, `983e622`, `3f67add`, `1cc6825`, `c494b60`, `0cbd46e`, `1cbf9fc`, `4cc3d66`, `0175b3c`, `fc04494`, `a880cb4`, `3fb108f`, `de0f1bb`, `eb3cff2`, and `aee6e83` are committed on `green-baseline` | done for current slices |
...
| Dawid-Skene / source reliability from plan | Source posterior, outcome-confusion likelihoods, panel tempering, EM-readiness counts, latent-label consensus/conflict diagnostics, and compact fixed-iteration EM fit diagnostics exist | `cargo test --lib source_reliability`; `cargo test --lib source_outcome_confusion`; `cargo test --lib source_reliability_em_readiness_requires_multi_source_overlap` | partial: no persisted/consumed full source confusion-matrix learning yet |
...
- `artifact-validation prior source` now has compact source-confusion likelihood cells, panel tempering, cross-source EM-readiness diagnostics, latent-label consensus telemetry, and fixed-iteration EM fit diagnostics, but still lacks persisted/consumed full Dawid-Skene source confusion-matrix learning.
...
2. Move to a non-P6 TODO slice: fuller recursive BOCPD run-length posterior modeling, full target-policy probability calibration, or persisted/consumed source-reliability EM once readiness and fit diagnostics are sufficient.
