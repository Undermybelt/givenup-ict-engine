...
2. Move to a non-P6 TODO slice: deeper target-policy probability modeling, full delayed-reward competing-risk modeling, BOCPD changepoint filtering over richer sequence history, or real larger-panel source-reliability EM calibration validation once enough cross-source labels exist.
