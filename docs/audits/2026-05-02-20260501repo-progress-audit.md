...
2. Move to a non-P6 TODO slice: full target-policy probability calibration, survival/competing-risk delayed-reward modeling, full BOCPD changepoint filtering over richer sequence history, or real larger-panel source-reliability EM calibration validation once enough cross-source labels exist.
