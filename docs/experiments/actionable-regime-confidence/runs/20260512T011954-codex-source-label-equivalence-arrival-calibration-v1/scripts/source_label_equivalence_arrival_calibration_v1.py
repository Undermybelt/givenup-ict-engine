...
RUN_ID = "20260512T011954-codex-source-label-equivalence-arrival-calibration-v1"
OUT = RUN_ROOT / "source-label-equivalence-arrival-calibration"
...
NIFTY_METADATA = Path("/tmp/ict-engine-source-label-equivalence-reconstruction-v1/nifty/dataset-metadata.json")
VERIFIER = REPO / (
...
def main() -> int:
    ...
    json_path = OUT / "source_label_equivalence_arrival_calibration_v1.json"
    report_path = OUT / "source_label_equivalence_arrival_calibration_v1.md"
    split_csv = OUT / "source_label_equivalence_arrival_calibration_label_split_v1.csv"
    owner_csv = OUT / "source_label_equivalence_arrival_calibration_owner_v1.csv"
    market_csv = OUT / "source_label_equivalence_arrival_calibration_market_v1.csv"
    gates_csv = OUT / "source_label_equivalence_arrival_calibration_gates_v1.csv"
    assertions_path = CHECKS / "source_label_equivalence_arrival_calibration_v1_assertions.out"
