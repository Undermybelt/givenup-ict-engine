# CME Group R6 Oystacher Normal-Control Export Request v4
...
Request ask:
- Please confirm licensed historical coverage and export path for the Oystacher 2011-2013 CME/NYMEX/COMEX cells below.
- Preferred data shape is Market Depth/FIX-FAST, Market by Order if product/date coverage exists, or a licensed equivalent that can provide verifier-native normal/non-manipulation rows with provenance.
