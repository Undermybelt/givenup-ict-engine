...
Decision: `current_goal_completion_audit_v44=post_cleanup_live_24x24_still_blocked`.
...
Result:
- Board hash before run: `6708d8692af19d62917367c10ee8173ae08148de57abd6d9c51fbd8e31adce48`.
- Current cursor before run: `20260511T212401+0800-codex-current-goal-completion-audit-v43-post-cleanup`.
...
| `R1_every_regime_95` | `fail_blocked` | cursor=20260511T212401+0800-codex-current-goal-completion-audit-v43-post-cleanup; ready_roots=1/4; direct_min_wilson95_lcb=0.862024 | Strict all-regime 95% objective is still not achieved; R6 direct confidence is below 0.95 and R2/R3/R4/R5 source roots are absent. |
...
| `R7_multi_agent_safety` | `pass_guardrail` | board_hash_before=6708d8692af19d62917367c10ee8173ae08148de57abd6d9c51fbd8e31adce48; cursor_before=20260511T212401+0800-codex-current-goal-completion-audit-v43-post-cleanup; append-only registration expected |  |
...
Artifacts:
- JSON: `docs/experiments/actionable-regime-confidence/runs/20260511T212711-codex-current-goal-completion-audit-v44-post-212325/completion-audit/current_goal_completion_audit_v44_post_212325.json`
- Report: `docs/experiments/actionable-regime-confidence/runs/20260511T212711-codex-current-goal-completion-audit-v44-post-212325/completion-audit/current_goal_completion_audit_v44_post_212325.md`
- Checklist CSV: `docs/experiments/actionable-regime-confidence/runs/20260511T212711-codex-current-goal-completion-audit-v44-post-212325/completion-audit/current_goal_completion_audit_v44_checklist.csv`
- Gate CSV: `docs/experiments/actionable-regime-confidence/runs/20260511T212711-codex-current-goal-completion-audit-v44-post-212325/completion-audit/current_goal_completion_audit_v44_gates.csv`
- Intake-root CSV: `docs/experiments/actionable-regime-confidence/runs/20260511T212711-codex-current-goal-completion-audit-v44-post-212325/completion-audit/current_goal_completion_audit_v44_intake_roots.csv`
- Verifier outputs: `docs/experiments/actionable-regime-confidence/runs/20260511T212711-codex-current-goal-completion-audit-v44-post-212325/command-output`
- Assertions: `docs/experiments/actionable-regime-confidence/runs/20260511T212711-codex-current-goal-completion-audit-v44-post-212325/checks/current_goal_completion_audit_v44_post_212325_assertions.out`
