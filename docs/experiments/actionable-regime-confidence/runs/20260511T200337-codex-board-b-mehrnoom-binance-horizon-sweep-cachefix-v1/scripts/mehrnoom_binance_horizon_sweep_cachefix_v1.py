...
RUN_ID = "20260511T200337+0800-codex-board-b-mehrnoom-binance-horizon-sweep-cachefix-v1"
RUN_SLUG = "20260511T200337-codex-board-b-mehrnoom-binance-horizon-sweep-cachefix-v1"
...
OUT_DIR = RUN_ROOT / "mehrnoom-binance-horizon-sweep-cachefix"
...
REPORT_JSON = OUT_DIR / "mehrnoom_binance_horizon_sweep_cachefix_v1.json"
REPORT_MD = OUT_DIR / "mehrnoom_binance_horizon_sweep_cachefix_v1.md"
SUMMARY_CSV = OUT_DIR / "mehrnoom_binance_horizon_sweep_cachefix_summary_v1.csv"
ASSERTIONS = CHECK_DIR / "mehrnoom_binance_horizon_sweep_cachefix_v1_assertions.out"
...
def main() -> int:
    ...
    report = {
        "run_id": RUN_ID,
        "schema_version": "board-b-mehrnoom-binance-horizon-sweep-cachefix/v1",
