...
RUN_ROOT="docs/experiments/actionable-regime-confidence/runs/20260512T150316+0800-codex-145809-provider-backed-downstream-chain-v1"
SYMBOL="B2R_PROVIDER_BACKED_HD_145809"
STATE_DIR="$RUN_ROOT/state_chain_v1"
MANIFEST="$RUN_ROOT/derived/strategy_library_145809_provider_backed_v1.json"
TRADES="$RUN_ROOT/derived/provider_backed_high_density_real_trades.jsonl"
...
run_step 01_build_downstream_inputs \
  /usr/bin/env python3 "$RUN_ROOT/scripts/build_145809_downstream_inputs.py"
