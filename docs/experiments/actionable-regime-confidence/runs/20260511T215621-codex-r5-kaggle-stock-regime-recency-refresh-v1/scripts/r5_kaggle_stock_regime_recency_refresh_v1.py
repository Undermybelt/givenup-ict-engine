...
RUN_ID = "20260511T215621-codex-r5-kaggle-stock-regime-recency-refresh-v1"
REPO = Path(__file__).resolve().parents[6]
RUN_ROOT = Path(__file__).resolve().parents[1]
OUT = RUN_ROOT / "r5-kaggle-stock-regime-recency-refresh"
CHECKS = RUN_ROOT / "checks"
COMMAND_OUT = RUN_ROOT / "command-output"
DOWNLOAD_ROOT = Path("/tmp/ict-engine-kaggle-stock-regimes-live-refresh-20260511T215621")
...
def main() -> int:
    ...
    decision = (
        "r5_kaggle_stock_regime_recency_refresh_v1=recency_extension_rows_materialized"
        if verifier_ready
        else "r5_kaggle_stock_regime_recency_refresh_v1=latest_public_dataset_no_post_2026_01_30_rows"
    )
    ...
    json_path = OUT / "r5_kaggle_stock_regime_recency_refresh_v1.json"
    md_path = OUT / "r5_kaggle_stock_regime_recency_refresh_v1.md"
    targets_csv = OUT / "r5_kaggle_stock_regime_recency_refresh_targets_v1.csv"
    assertions_path = CHECKS / "r5_kaggle_stock_regime_recency_refresh_v1_assertions.out"
