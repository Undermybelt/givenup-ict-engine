...
class DisplacementFvgRetestExpansionV1(IStrategy):
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = long_trend & bull_fvg_retest & displacement
        dataframe.loc[condition, ["enter_long", "enter_tag"]] = (1, "fvg_displacement_retest_expansion_v1")
        return dataframe
