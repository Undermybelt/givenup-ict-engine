...
class OteObContinuationLongV1(IStrategy):
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = long_trend & ote_zone & bull_ob_retest
        dataframe.loc[condition, ["enter_long", "enter_tag"]] = (1, "ote_ob_continuation_long_v1")
        return dataframe
