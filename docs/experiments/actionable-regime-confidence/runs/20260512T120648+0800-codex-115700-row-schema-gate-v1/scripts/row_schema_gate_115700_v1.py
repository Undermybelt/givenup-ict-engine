...
RUN_ID = "20260512T120648+0800-codex-115700-row-schema-gate-v1"
ROOT = Path("docs/experiments/actionable-regime-confidence/runs/20260512T120648+0800-codex-115700-row-schema-gate-v1")
...
EVALUATED = {
    "115700": {
        ...
        "path": Path("docs/experiments/actionable-regime-confidence/runs/20260512T115700+0800-codex-same-root-six-provider-1h-aq-v1"),
...
def main():
    ...
    result = {
        ...
        "classification": {
            "115700": "infrastructure_repair_candidate_plus_chain_contract_negative_sample",
