#!/usr/bin/env python3
"""Board B B2R repeat-next: Bear/Sideways/Crisis cost repair panel.

Run-local experiment only. It consumes cached local Auto-Quant OHLCV data,
attaches Board A source-root labels, scores predeclared root-specific NQ repair
variants, and combines the existing direct Manipulation stop/TP component as a
separate component. It does not modify ict-engine runtime code or Auto-Quant.
"""
...
RUN_ID = "20260512T031036+0800-codex-board-b-b2r-bear-sideways-crisis-cost-repair-v1"
SCHEMA_VERSION = "board-b-b2r-bear-sideways-crisis-cost-repair/v1"
RECIPE_ID = "BearSidewaysCrisisCostRepairV1"
SYMBOL = "B2R_NQ_BEAR_SIDEWAYS_CRISIS_COST_REPAIR_031036"
...
VARIANTS: list[dict[str, Any]] = [
    {
        "root": "Bull",
        "variant_id": "bull_cost_breakout_h72_r200_v12",
        "branch_path": "Bull -> TrendExpansion -> CostDurableNQ -> BearSidewaysCrisisCostRepairV1:bull_cost_breakout_h72_r200_v12",
        "hold": 72,
        "action": "long",
        "ret72_min": 0.0200,
    ...
    {
        "root": "Bull",
        "variant_id": "bull_cost_breakout_h72_r140_v12",
        "branch_path": "Bull -> TrendExpansion -> CostDurableNQ -> BearSidewaysCrisisCostRepairV1:bull_cost_breakout_h72_r140_v12",
        "hold": 72,
        "action": "long",
        "ret72_min": 0.0140,
        "close_above_ema": "ema_96",
    ...
    {
        "root": "Bull",
        "variant_id": "bull_cost_breakout_h48_r200_v12",
        "branch_path": "Bull -> TrendExpansion -> CostDurableNQ -> BearSidewaysCrisisCostRepairV1:bull_cost_breakout_h48_r200_v12",
        "hold": 48,
        "action": "long",
        "ret72_min": 0.0200,
        "close_above_ema": "ema_96",
    ...
    {
        "root": "Bull",
        "variant_id": "bull_cost_breakout_h72_r100_v12",
        "branch_path": "Bull -> TrendExpansion -> CostDurableNQ -> BearSidewaysCrisisCostRepairV1:bull_cost_breakout_h72_r100_v12",
        "hold": 72,
        "action": "long",
        "ret72_min": 0.0100,
        "close_above_ema": "ema_96",
    ...
    {
        "root": "Bear",
        "variant_id": "bear_cap_rebound_h72_r250",
        "branch_path": "Bear -> BearMarketDrawdown -> AbstainCarryRepairNQ -> BearSidewaysCrisisCostRepairV1:bear_cap_rebound_h72_r250",
        "hold": 72,
        "action": "long",
        "ret24_max": -0.0250,
        "vol_z_min": -0.20,
    ...
    {
        "root": "Bear",
        "variant_id": "bear_cap_rebound_h72_r120",
        "branch_path": "Bear -> BearMarketDrawdown -> AbstainCarryRepairNQ -> BearSidewaysCrisisCostRepairV1:bear_cap_rebound_h72_r120",
        "hold": 72,
        "action": "long",
        "ret24_max": -0.0120,
        "vol_z_min": -0.20,
    ...
    {
        "root": "Bear",
        "variant_id": "bear_cap_rebound_h48_r250",
        "branch_path": "Bear -> BearMarketDrawdown -> AbstainCarryRepairNQ -> BearSidewaysCrisisCostRepairV1:bear_cap_rebound_h48_r250",
        "hold": 48,
        "action": "long",
        "ret24_max": -0.0250,
        "vol_z_min": -0.20,
    ...
    {
        "root": "Bear",
        "variant_id": "bear_cap_rebound_h72_r180",
        "branch_path": "Bear -> BearMarketDrawdown -> AbstainCarryRepairNQ -> BearSidewaysCrisisCostRepairV1:bear_cap_rebound_h72_r180",
        "hold": 72,
        "action": "long",
        "ret24_max": -0.0180,
        "vol_z_min": -0.20,
    ...
    {
        "root": "Bear",
        "variant_id": "bear_cap_rebound_h48_r120",
        "branch_path": "Bear -> BearMarketDrawdown -> AbstainCarryRepairNQ -> BearSidewaysCrisisCostRepairV1:bear_cap_rebound_h48_r120",
        "hold": 48,
        "action": "long",
        "ret24_max": -0.0120,
        "vol_z_min": -0.20,
    ...
    {
        "root": "Sideways",
        "variant_id": "side_band_revert_h24_z16_a12",
        "branch_path": "Sideways -> RangeConsolidation -> AbstainCarryRepairNQ -> BearSidewaysCrisisCostRepairV1:side_band_revert_h24_z16_a12",
        "hold": 24,
        "action": "z_revert",
        "ret72_abs_max": 0.0120,
        "zscore_abs_min": 1.60,
        "vol_z_max": 1.00,
    },
    {
        "root": "Sideways",
        "variant_id": "side_band_revert_h24_z12_a12",
        "branch_path": "Sideways -> RangeConsolidation -> AbstainCarryRepairNQ -> BearSidewaysCrisisCostRepairV1:side_band_revert_h24_z12_a12",
        "hold": 24,
        "action": "z_revert",
        "ret72_abs_max": 0.0120,
        "zscore_abs_min": 1.20,
    ...
    {
        "root": "Sideways",
        "variant_id": "side_band_revert_h24_z6_a12",
        "branch_path": "Sideways -> RangeConsolidation -> AbstainCarryRepairNQ -> BearSidewaysCrisisCostRepairV1:side_band_revert_h24_z6_a12",
        "hold": 24,
        "action": "z_revert",
        "ret72_abs_max": 0.0120,
        "zscore_abs_min": 0.60,
    ...
    {
        "root": "Sideways",
        "variant_id": "side_pull_revert_h24_z16_a30",
        "branch_path": "Sideways -> RangeConsolidation -> AbstainCarryRepairNQ -> BearSidewaysCrisisCostRepairV1:side_pull_revert_h24_z16_a30",
        "hold": 24,
        "action": "long",
        "ret6_max": -0.0015,
    ...
    {
        "root": "Crisis",
        "variant_id": "crisis_rebound_h72_r120",
        "branch_path": "Crisis -> ExtremeStress -> CrisisDepthRepairNQ -> BearSidewaysCrisisCostRepairV1:crisis_rebound_h72_r120",
        "hold": 72,
        "action": "long",
        "ret24_max": -0.0120,
        "vol_z_min": -0.50,
    ...
    {
        "root": "Crisis",
        "variant_id": "crisis_rebound_h72_r80",
        "branch_path": "Crisis -> ExtremeStress -> CrisisDepthRepairNQ -> BearSidewaysCrisisCostRepairV1:crisis_rebound_h72_r80",
        "hold": 72,
        "action": "long",
        "ret24_max": -0.0080,
        "vol_z_min": -0.50,
    ...
    {
        "root": "Crisis",
        "variant_id": "crisis_rebound_h72_r40",
        "branch_path": "Crisis -> ExtremeStress -> CrisisDepthRepairNQ -> BearSidewaysCrisisCostRepairV1:crisis_rebound_h72_r40",
        "hold": 72,
        "action": "long",
        "ret24_max": -0.0040,
        "vol_z_min": -0.50,
    ...
    {
        "root": "Crisis",
        "variant_id": "crisis_rebound_h48_r80",
        "branch_path": "Crisis -> ExtremeStress -> CrisisDepthRepairNQ -> BearSidewaysCrisisCostRepairV1:crisis_rebound_h48_r80",
        "hold": 48,
        "action": "long",
        "ret24_max": -0.0080,
        "vol_z_min": -0.50,
...
OUT_DIR = RUN_ROOT / "bear-sideways-crisis-cost-repair"
CHECK_DIR = RUN_ROOT / "checks"
COMMAND_DIR = RUN_ROOT / "command-output"
STATE_SYMBOL_DIR = RUN_ROOT / "state_bear_sideways_crisis_cost_repair_v1" / SYMBOL

REPORT_JSON = OUT_DIR / "bear_sideways_crisis_cost_repair_rc_spa_v1.json"
REPORT_MD = OUT_DIR / "bear_sideways_crisis_cost_repair_rc_spa_v1.md"
VARIANT_ROWS_CSV = OUT_DIR / "bear_sideways_crisis_cost_repair_variant_rows_v1.csv"
SELECTED_ROWS_CSV = OUT_DIR / "bear_sideways_crisis_cost_repair_selected_rows_v1.csv"
BRANCH_SUMMARY_CSV = OUT_DIR / "bear_sideways_crisis_cost_repair_branch_summary_v1.csv"
INPUTS_JSON = OUT_DIR / "bear_sideways_crisis_cost_repair_inputs_v1.json"
REAL_TRADES = OUT_DIR / "bear_sideways_crisis_cost_repair_real_trades_v1.jsonl"
STRATEGY_LIBRARY = OUT_DIR / "strategy_library_bear_sideways_crisis_cost_repair_v1.json"
ASSERTIONS = CHECK_DIR / "bear_sideways_crisis_cost_repair_v1_assertions.out"
...
def add_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    for hold in [3, 6, 12, 24, 36, 48, 72]:
...
def manipulation_component() -> dict[str, Any]:
    assertions_path = REPO_ROOT / MANIP_ASSERTIONS
    summary_path = REPO_ROOT / MANIP_SUMMARY
    ...
    return {
        ...
        "component_source": rel(assertions_path),
        "component_summary": rel(summary_path),
    }
    ...
    with REAL_TRADES.open("w", encoding="utf-8") as handle:
        for idx, row in enumerate(selected_rows, start=1):
            ...
            record = {
                ...
                "strategy_mutation_id": "b2r_bear_sideways_crisis_cost_repair_v1",
                "symbol": SYMBOL,
                "trade_id": f"bsc_cost_repair_{idx:06d}",
        ...
        strategies.append(
            {
                ...
                "metadata": {
                    ...
                    "mutation_id": "b2r_bear_sideways_crisis_cost_repair_v1",
...
def main() -> int:
    ...
    primary_blocker = (
        ...
        if all_required_passed
        else "Bear/Sideways/Crisis cost-repair panel repaired the missing fwd3 horizon, kept the NQ long-history source-root join, and combined the scoped Manipulation component, but at least one required branch RC-SPA gate still failed."
    )
    report = {
        "run_id": RUN_ID,
        "schema_version": SCHEMA_VERSION,
        ...
        "decision": {
            ...
            "next_action": (
                ...
                if all_required_passed
                else "Do not run downstream. Use this as nursery feedback: keep the fwd3-capable NQ source-root join and repair the failing branch gate(s), especially Sideways/Crisis edge and source-owned Manipulation PnL, before another downstream attempt."
            ),
        },
        "artifacts": {
