...
RUN_ID = "20260512T031559+0800-codex-board-b-nq-cost-crisis-repair-v1"
SCHEMA_VERSION = "board-b-nq-cost-crisis-repair/v1"
RECIPE_ID = "NQRootAdaptiveCostCrisisRepairV1"
SYMBOL = "B2R_NQ_COST_CRISIS_REPAIR_031559"
...
def main() -> int:
    ...
    base.OUT_DIR = RUN_ROOT / "nq-cost-crisis-repair"
    base.CHECK_DIR = RUN_ROOT / "checks"
    base.COMMAND_DIR = RUN_ROOT / "command-output"
    base.STATE_SYMBOL_DIR = RUN_ROOT / "state_nq_cost_crisis_repair_v1" / SYMBOL
    base.REPORT_JSON = base.OUT_DIR / "nq_cost_crisis_repair_rc_spa_v1.json"
    base.REPORT_MD = base.OUT_DIR / "nq_cost_crisis_repair_rc_spa_v1.md"
    base.VARIANT_ROWS_CSV = base.OUT_DIR / "nq_cost_crisis_repair_variant_rows_v1.csv"
    base.SELECTED_ROWS_CSV = base.OUT_DIR / "nq_cost_crisis_repair_selected_rows_v1.csv"
    base.BRANCH_SUMMARY_CSV = base.OUT_DIR / "nq_cost_crisis_repair_branch_summary_v1.csv"
    base.INPUTS_JSON = base.OUT_DIR / "nq_cost_crisis_repair_inputs_v1.json"
    base.REAL_TRADES = base.OUT_DIR / "nq_cost_crisis_repair_real_trades_v1.jsonl"
    base.STRATEGY_LIBRARY = base.OUT_DIR / "strategy_library_nq_cost_crisis_repair_v1.json"
    base.ASSERTIONS = base.CHECK_DIR / "nq_cost_crisis_repair_v1_assertions.out"
