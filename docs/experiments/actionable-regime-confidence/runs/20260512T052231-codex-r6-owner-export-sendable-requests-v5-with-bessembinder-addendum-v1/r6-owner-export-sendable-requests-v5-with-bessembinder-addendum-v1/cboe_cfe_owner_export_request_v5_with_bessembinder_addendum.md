# Cboe/CFE R6 Owner Export Request v5 With Bessembinder Addendum

Use this with the existing Cboe/CFE request v4:

- Base request: `docs/experiments/actionable-regime-confidence/runs/20260512T015040-codex-r6-owner-export-sendable-requests-v4-current-routes-v1/r6-owner-export-sendable-requests-v4-current-routes-v1/cboe_cfe_owner_export_request_v4.md`
- Delivery root after approval/export: `/tmp/ict-engine-board-a-r6-owner-export-v1`

## Add To The Cboe/CFE Request

Please also include, if available through Cboe DataShop, CFE market-data services, CFTC/court-source materials, or licensed exchange data systems, verifier-native Bessembinder/CFTC comparison-cohort rows for the same Oystacher CFE/VIX products and date windows requested in v4.
