#!/usr/bin/env python3
"""Read-only Board A source/control arrival poll after the 090725 current-objective audit."""
...
RUN_ID = "20260512T091136+0800-codex-source-control-arrival-poll-after-090725-v1"
...
PRIOR_ASSERTIONS = [
    (
        "085908_r3_r5_required_root_local_sweep",
        REPO
        / "docs/experiments/actionable-regime-confidence/runs/"
        "20260512T085908+0800-codex-r3-r5-required-root-local-sweep-after-085612-v1/"
        "checks/r3_r5_required_root_local_sweep_after_085612_v1_assertions.out",
    ),
    (
        "090725_current_objective_audit",
        PRIOR_090725
        / "checks/current_objective_audit_after_085908_v1_assertions.out",
    ),
]
...
def main() -> int:
    ...
    target_csv = OUT_DIR / "source_control_target_roots_after_090725_v1.csv"
    dropzone_csv = OUT_DIR / "source_control_dropzone_candidates_after_090725_v1.csv"
    prior_csv = OUT_DIR / "source_control_prior_assertions_after_090725_v1.csv"
