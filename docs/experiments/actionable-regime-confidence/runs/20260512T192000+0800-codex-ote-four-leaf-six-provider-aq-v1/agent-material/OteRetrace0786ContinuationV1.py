...
class OteRetrace0786ContinuationV1(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["ote_price"] = dataframe["swing_high_48"] - dataframe["impulse_range_48"] * 0.786
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[pullback_continuation, "enter_tag"] = "ote_retrace_0786_continuation_v1"
        return dataframe
