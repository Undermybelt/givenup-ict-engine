...
pub use crate::belief_core::structural_state::{
    StructuralPathArtifact, StructuralPathPlanArtifact, StructuralRecommendedPathBundleArtifact,
    StructuralTopPathCandidate, StructuralTopPathCandidatesArtifact,
};
