...
use crate::belief_core::changepoint_gate::{
    structural_bocpd_break_probability, structural_duration_surprise,
    structural_node_bocpd_recursive_run_length_fit,
    structural_node_bocpd_sequence_break_probability,
    structural_node_bocpd_sequence_change_intensity,
    structural_node_bocpd_sequence_recursive_run_length_fit,
    structural_node_duration_distribution_fit, StructuralNodeStreakRecord,
};
