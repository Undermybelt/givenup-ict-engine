#!/usr/bin/env python3
"""Post-NIFTY source-label completion audit for Board A.
...
RUN_ID = "20260511T213129-codex-current-goal-completion-audit-v45-after-nifty-source-label"
...
def main() -> int:
    ...
    checklist = [
        ...
        },
        {
            ...
            "status": "fail_blocked",
            "gap": "NIFTY source-label equivalence rows are present but only schema-ready/unscored, partial to Bull/Crisis/Sideways, and not a >=95 confidence acceptance package.",
        },
        {
        ...
        },
        {
            ...
            "evidence": "This audit keeps VantMacro drafts, missing intake roots, same-event controls, NIFTY schema-ready source labels, and OHLCV/provider proxies fail-closed.",
    ...
    decision = f"current_goal_completion_audit_v45=after_nifty_source_label_{len(ready_roots)}of4_roots_still_blocked"
    result = {
        "run_id": RUN_ID,
    ...
    json_path = OUT_DIR / "current_goal_completion_audit_v45_after_nifty_source_label.json"
    ...
    report_path = OUT_DIR / "current_goal_completion_audit_v45_after_nifty_source_label.md"
    assertions_path = CHECK_DIR / "current_goal_completion_audit_v45_after_nifty_source_label_assertions.out"
