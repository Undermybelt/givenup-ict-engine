#!/usr/bin/env python3
"""Post-US-panel source-label completion audit for Board A.
...
RUN_ID = "20260511T213705-codex-current-goal-completion-audit-v46-after-us-panel-source-label-extension"
...
def main() -> int:
    ...
    decision = f"current_goal_completion_audit_v46=after_us_panel_source_label_extension_{len(ready_roots)}of4_roots_still_blocked"
    result = {
        "run_id": RUN_ID,
    ...
    json_path = OUT_DIR / "current_goal_completion_audit_v46_after_us_panel_source_label_extension.json"
    ...
    report_path = OUT_DIR / "current_goal_completion_audit_v46_after_us_panel_source_label_extension.md"
    assertions_path = CHECK_DIR / "current_goal_completion_audit_v46_after_us_panel_source_label_extension_assertions.out"
