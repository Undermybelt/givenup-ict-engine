...
class SmtConfirmedObFvgContinuationV1(IStrategy):
    timeframe = "1h"
    can_short = False
    minimal_roi = {"0": 0.017, "24": 0}
    stoploss = -0.033
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = long_trend & smt_proxy & (bull_fvg_retest | bull_ob_retest)
        dataframe.loc[condition, ["enter_long", "enter_tag"]] = (1, "smt_confirmed_ob_fvg_continuation_v1")
        return dataframe
