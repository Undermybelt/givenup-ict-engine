...
class SessionObContinuationV1(IStrategy):
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = long_trend & bull_ob_retest & (dataframe["volume"] > 0)
        dataframe.loc[condition, ["enter_long", "enter_tag"]] = (1, "session_ob_continuation_v1")
        return dataframe
