...
class ObFvgFailedMitigationGuardV1(IStrategy):
    timeframe = "1h"
    can_short = False
    minimal_roi = {"0": 0.01, "24": 0}
    stoploss = -0.018
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = failed_mitigation & ~(bull_fvg_retest | bull_ob_retest | bear_fvg_retest | bear_ob_retest)
        dataframe.loc[condition, ["enter_long", "enter_tag"]] = (1, "ob_fvg_failed_mitigation_guard_v1")
        return dataframe
