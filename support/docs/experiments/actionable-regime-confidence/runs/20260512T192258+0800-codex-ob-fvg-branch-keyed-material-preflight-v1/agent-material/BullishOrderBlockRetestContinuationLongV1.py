...
class BullishOrderBlockRetestContinuationLongV1(IStrategy):
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = long_trend & bull_ob_retest & (dataframe["close"] > dataframe["open"])
        dataframe.loc[condition, ["enter_long", "enter_tag"]] = (1, "order_block_retest_continuation_long_v1")
        return dataframe
