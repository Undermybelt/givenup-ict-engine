...
class ObFvgConfluenceContinuationLongV1(IStrategy):
    timeframe = "1h"
    can_short = False
    minimal_roi = {"0": 0.02, "24": 0}
    stoploss = -0.038
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = long_trend & bull_fvg_retest & bull_ob_retest
        dataframe.loc[condition, ["enter_long", "enter_tag"]] = (1, "ob_fvg_confluence_continuation_long_v1")
        return dataframe
