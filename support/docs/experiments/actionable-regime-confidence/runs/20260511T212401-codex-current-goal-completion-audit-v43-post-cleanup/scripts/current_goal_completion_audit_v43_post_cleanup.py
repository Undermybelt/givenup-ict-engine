...
RUN_ID = "20260511T212401-codex-current-goal-completion-audit-v43-post-cleanup"
...
def main() -> int:
    ...
    decision = f"current_goal_completion_audit_v43=post_cleanup_live_{positive_rows}x{matched_negative_rows}_still_blocked"
    result = {
        "run_id": RUN_ID,
    ...
    json_path = OUT_DIR / "current_goal_completion_audit_v43_post_cleanup.json"
    checklist_csv = OUT_DIR / "current_goal_completion_audit_v43_checklist.csv"
    gates_csv = OUT_DIR / "current_goal_completion_audit_v43_gates.csv"
    roots_csv = OUT_DIR / "current_goal_completion_audit_v43_intake_roots.csv"
    report_path = OUT_DIR / "current_goal_completion_audit_v43_post_cleanup.md"
    assertions_path = CHECK_DIR / "current_goal_completion_audit_v43_post_cleanup_assertions.out"
