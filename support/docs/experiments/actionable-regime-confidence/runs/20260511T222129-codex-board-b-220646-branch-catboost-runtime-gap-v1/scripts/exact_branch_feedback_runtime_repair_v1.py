...
RUN_ID = "20260511T222129+0800-codex-board-b-220646-branch-catboost-runtime-gap-v1"
...
BRANCH_SCORES = RUN_ROOT / "catboost/branch_catboost_scores_v1.csv"
MODEL_PATH = RUN_ROOT / "catboost/branch_catboost_model_v1.cbm"

OUT_DIR = RUN_ROOT / "ict-engine-exact-branch-feedback-repair"
FEEDBACK_DIR = OUT_DIR / "feedback"
LOG_DIR = OUT_DIR / "logs"
STATE_DIR = OUT_DIR / "state_exact_branch_feedback_v1"
EXPORT_BEFORE = OUT_DIR / "exact_branch_target_export_before_scores_v1.json"
SCORES_FILE = OUT_DIR / "exact_branch_runtime_scores_v1.csv"
SUMMARY_JSON = OUT_DIR / "exact_branch_feedback_runtime_repair_v1.json"
SUMMARY_MD = OUT_DIR / "exact_branch_feedback_runtime_repair_v1.md"
ASSERTIONS = OUT_DIR / "exact_branch_feedback_runtime_repair_v1_assertions.out"
