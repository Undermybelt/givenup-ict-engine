...
- `/Users/thrill3r/Auto-Quant/user_data/data/options/bybit_BTC.csv` rows=500 matches={'bid_ask': ['ask_price', 'bid_price']}; rejected for Manipulation acceptance because this is an options quote surface, not an aligned tick/order-flow/L2/order-lifecycle or event/social manipulation label set.
