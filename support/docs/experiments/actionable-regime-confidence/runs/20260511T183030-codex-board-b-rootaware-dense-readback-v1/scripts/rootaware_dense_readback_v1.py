...
RUN_ID = "20260511T183030+0800-codex-board-b-rootaware-dense-readback-v1"
SCHEMA_VERSION = "board-b-rootaware-multibranch-rc-spa/v1"
RECIPE_ID = "RootAwareDenseReadbackV1"
STRATEGY_CLASS = "RootAwareDenseReadbackV1"
...
class RootAwareDenseReadbackV1(IStrategy):
    INTERFACE_VERSION = 3
...
def main() -> int:
    ...
    decision = {
        ...
        "primary_blocker": (
            "RootAwareDenseReadbackV1 emits root-first branches and real Auto-Quant/Freqtrade "
