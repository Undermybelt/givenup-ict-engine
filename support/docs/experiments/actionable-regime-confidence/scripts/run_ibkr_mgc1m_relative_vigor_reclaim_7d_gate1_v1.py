...
def main() -> int:
    ...
    metrics = {
        "run_root": str(base.ROOT), "source_provider_root": str(base.SOURCE_ROOT), "factor_id": base.FACTOR_ID, "branch_path": base.BRANCH_PATH,
        "decision": decision, "source_backed_family": "Relative Vigor Index / RVI reclaim", "provider_rows": provider_rows, "rank_rows": len(rank_rows),
    ...
    lines = ["# Terminal Decision Summary", "", f"Decision: `{decision}`", "", "Source: `github.com/cinar/indicator` Relative Vigor Index idea source; rewritten as Freqtrade/AQ material with no Go runtime dependency.", "", "Exact MGC 1m RVI reclaim rows:", "", "| label | trades | win_rate | raw | 1bps | 2bps | 5bps |", "|---|---:|---:|---:|---:|---:|---:|"]
